  ...
  return (
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="pl-4 pt-8">
        <button className="outline-white border flex justify-between items-center gap-3 px-5 py-2 text-white rounded-lg hover:bg-white hover:text-gray-500">
          <FaCheck />
          Select
        </button>
      </div>
      ...
      <div className="flex flex-col items-center pt-4 px-4 flex-grow">
        <h1 className="text-center text-xl font-bold text-white">CASH WALLET</h1>
